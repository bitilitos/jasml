...
import classes.Attribute_Code;
import classes.Attribute_Code.ExceptionTableItem;
import classes.Attribute_Code.Opcode;
import classes.Attribute_ConstantValue;
import classes.Attribute_Deprecated;
import classes.Attribute_Exceptions;
import classes.Attribute_InnerClasses;
import classes.Attribute_InnerClasses.InnerClass;
import classes.Attribute_LineNumberTable;
import classes.Attribute_LineNumberTable.LineNumber;
import classes.Attribute_LocalVariableTable;
import classes.Attribute_LocalVariableTable.LocalVariable;
import classes.Attribute_SourceFile;
import classes.Attribute_Synthetic;
import classes.ConstantPool;
import classes.ConstantPoolItem;
import classes.Constant_Class;
import classes.Constant_Double;
import classes.Constant_Fieldref;
import classes.Constant_Float;
import classes.Constant_Integer;
import classes.Constant_InterfaceMethodref;
import classes.Constant_Long;
import classes.Constant_Methodref;
import classes.Constant_NameAndType;
import classes.Constant_String;
import classes.Constant_Utf8;
import classes.Constants;
import classes.Field;
import classes.JavaClass;
import classes.Method;
import helper.OpcodeHelper;
import helper.OpcodeInfo;
import helper.Util;
...
public class JavaClassParser {
	...
	private ExceptionTableItem readExceptionTableItem(DataInputStream in) throws IOException {
	...
	private InnerClass readInnerClass(DataInputStream in) throws IOException {
	...
	private LineNumber readLineNumber(DataInputStream in) throws IOException {
		return new Attribute_LineNumberTable.LineNumber(in.readUnsignedShort(), in.readUnsignedShort());
	}

	private LocalVariable readLocalVariable(DataInputStream in) throws IOException {
	...
	private Opcode[] parseOpcodes(byte[] bytes) {
